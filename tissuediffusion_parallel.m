function [traj, headerinfo, stats] = tissuediffusion_parallel(tissue, numwalkers, max_t, dt, initialisation)
...
X = cell(numwalkers, max_t/dt);
Y = cell(numwalkers, max_t/dt);
Z = cell(numwalkers, max_t/dt);
S = cell(numwalkers, max_t/dt);
T = cell(numwalkers, max_t/dt);
I = cell(numwalkers, max_t/dt);
